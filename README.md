...
This web app: This web-app lets user discover random disney character images. It also lets the user ban certain images from appering. It uses a Disney API.
...
[Watch the walkthrough](./Disney.mp4)
